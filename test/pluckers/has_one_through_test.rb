...
class HasOneThroughTest < test_base_class
  ...
  def test_it_fetches_all_simple_attributes
    @subject = Pluckers::Base.new(BlogPost.scoped, reflections: { user: {} })
  ...
  def test_it_fetches_only_required_simple_attributes
    @subject = Pluckers::Base.new(BlogPost.scoped, reflections: { user: { attributes: [:email ]} })
  ...
  def test_it_renames_the_reflection
    @subject = Pluckers::Base.new(BlogPost.scoped, reflections: { user: { attributes: [:email ]} }, renames: { user: :account})
